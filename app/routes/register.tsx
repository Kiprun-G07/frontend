      ...
      <form onSubmit={handleSubmit} aria-describedby="form-error">
        ...
        <div className="mb-3">
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full border rounded px-3 py-2 text-gray-900 drdown"
          >
            <option value="" className="bg-transparent text-gray-900">Select Faculty</option>
            <option value="FOCS" className="bg-transparent text-gray-900">Faculty of Computing and Information Technology</option>
            <option value="FOE" className="bg-transparent text-gray-900">Faculty of Engineering</option>
            <option value="FOM" className="bg-transparent text-gray-900">Faculty of Management</option>
            <option value="FST" className="bg-transparent text-gray-900">Faculty of Science and Technology</option>
